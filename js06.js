//비구조 할당(Destructuring Assignment & Allocation) : 배열과 같은 자료구조(reference type)를 단일 기억장소(primitive type)으로 변경
const person = ['kim', 'lee', 'park', 'choi', 'yoon'] //배열 구조 
let p1 = person[0];
let p2 = person[1];
let p3 = person[2];
...
//UNDIFINED(비정의)
const [a, b, c] = ["JAVA", "C#"]
console.log(`a: ${a}, b: ${b}, c: ${c}`)  //c: undifined
